...
import { Twitter, GitHub } from "../Images";
const Hamburger = () => {
  ...
  return (
    <>
      ...
      <div className="scale-up-ver-top hambar hidden fixed z-50 w-screen">
        <ul
          className="space-y-2 grid place-items-center bg-navy-700 font-firaCode py-10 gap-5"
          onClick={hideNavMenu}
        >
          <li>
          ...
          <li>
            <a
              ...
              target="_blank"
              className="flex items-center gap-3 active:text-gray-400"
            >
              <GitHub /> GitHub
            </a>
          </li>
